...
");
    ...
    static List<string> adoptionRequests = new List<string>();
    ...
    {
        Console.Clear();
        DisplayHeader("Adoption Request");
        ...
        try
        {
            ...
            {
                adoptionRequests.Add($"{adopterName}-{animalId}");
                Console.WriteLine("Adoption request added successfully!");
    ...
    {
        Console.Clear();
        DisplayHeader("Track Adoption Request");
        ...
        try
        {
            ...
            {
                adoptionRequests.Add($"{adopterName}-{animalId}");
                Console.WriteLine("Tracking request added successfully!");
